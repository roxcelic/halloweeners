...
public class playerController : MonoBehaviour {
    ...
    #region utils
        ...
        public bool isGrounded() {
            return Physics.Raycast(transform.position, -Vector2.up, Vector3.Distance(transform.position, groundCheck.position) * 1.1f);
        }
    #endregion
    ...
    public IEnumerator slide() {
        ...
        while(eevee.input.Check("Slam")) {
            ...
            else if (slideForce.y < -stopSpeed) slideForce = new Vector3(slideForce.x, slideForce.y + slideDecay, slideForce.z);
